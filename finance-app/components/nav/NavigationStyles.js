...
export const navStyles = (current, showBar, page) => {
   return {
        ...
        BTNsWrapper: `2xl:w-full transition-all duration-700 2xl:pt-10 pt-[unset] md:gap-[42px] gap-0 h-full flex 2xl:flex-col 2xl:gap-1 flex-row ${showBar? 'md:pr-6':'pr-[9px]'}`
    }
}
