...
export const navStyles = (current, showBar, page) => {
   return {
        section: `2xl:h-screen flex-grow-0 transition-width duration-700 w-full ${showBar ? "2xl:w-[300px] relative md:w-[768px]" : "w-[88px] sm:w-full"
        ...
        BTNsWrapper: `w-full transition-all duration-700 2xl:pt-10 pt-[unset] md:gap-[42px] gap-0 h-full flex 2xl:flex-col 2xl:gap-1 flex-row ${showBar? 'pr-6':'pr-[9px]'}`
    }
}
